...
- [ ] Playtest M9 again — does the retuned night hold pressure without drowning the sorties, and does the early-dawn reward tempt you into risking the roost attacks? Knobs: lane periods (65/75/90s), wave sizes (2/2/3), the two mass launches
