...
- [ ] PACING DATA: M2 Claim Jumpers beaten in **9:44** (2026-07-29) — and that run skipped the return leg entirely. Target for early missions is ~15 min. Re-time it now the return is enforced before tuning further
